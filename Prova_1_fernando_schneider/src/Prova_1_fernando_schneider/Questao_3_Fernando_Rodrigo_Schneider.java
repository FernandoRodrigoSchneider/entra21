...
public class Questao_3_Fernando_Rodrigo_Schneider {
	...
	public static void main(String[] args) {
		...
		double[][] matriz = {
				{ 22.1, 23.5, 24.0, 23.8, 22.6, 21.9, 21.7, 22.2, 23.0, 24.1, 24.5, 24.0, 24.3, 24.4, 24.0, 24.5, 24.1,
						24.4, 24.8, 24.5, 24.3, 24.7, 24.9, 23.8 }, // domingo
				{ 21.8, 22.7, 23.2, 23.9, 23.7, 22.8, 22.5, 22.1, 22.9, 24.0, 24.6, 25.1, 26.2, 27.5, 28.1, 28.6, 29.2,
						29.5, 28.9, 27.6, 26.4, 25.8, 25.1, 24.0 }, // segunda
		...
		case "domingo":
			...
			System.out.println("A media da temperatura de " + diaSemana + " foi de " + (soma / 24));
			break;
		case "segunda":
		...
		case "sabado":
			...
			break;
		default:
			//System.out.println("dia informado errado");
			break;
		}
		
		System.out.println("infome a hora a ser pesquisada:");
		int hora = in.nextInt();
		int somaHora = 0;
		for (int i = 0; i < matriz.length; i++) {
			for (int j = 0; j < matriz[i].length; j++) {
		...
		System.out.println("A media na hora escolhida foi de "+(somaHora/7));
	}
